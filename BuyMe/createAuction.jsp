...
<form action="processCreateAuction.jsp" method="POST" onsubmit="return validateForm()">
    <h3>Vehicle Information</h3>
    
    <label>Vehicle Title:</label><br>
    <input type="text" name="title" id="title" required maxlength="50"><br><br>
    ...
    <label>Make:</label><br>
    <select name="make" id="make" required onchange="updateModels()">
